...
+ subst. apply value_is_hole_free in H6.  apply surface_syntax_is_hole_free in H13.
  assert (hole_free (MethodCall t1 i t2) = true). unfold hole_free. fold hole_free. rewrite H6.
  rewrite H13. auto.
  exists (Config CT (Container (MethodCall t1 i t2) fs lb sf) ctns h); auto.
...
- inversion H_config. inversion H7.  subst. inversion H16. inversion H1. subst.
  ...
  unfold surface_syntax. fold surface_syntax. rewrite H12. rewrite H13. rewrite H14. auto. 
...
(* need to add dot_free into this lemma  *)
(*
...
Proof. 
  ...
  + auto. + auto. Qed. 
Hint Resolve heap_preserve_typing.
(*
