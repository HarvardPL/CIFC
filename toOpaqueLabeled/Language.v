...
(*    | dot => false *)
    | return_hole => false
    | toOpaqueLabeled e => (surface_syntax e)
  end.
...
(* toOpaqueLabel *)
  | Valid_to_OpaqueLabel : forall e,
      surface_syntax e = true ->
      valid_syntax (toOpaqueLabeled e).
...
(* skip *)
  ...
  (* toOpaqueLabeled *)
  | ST_toOpaqueLabeled : forall e sf fs lb ctns h ct,
     Config ct (Container (toOpaqueLabeled e) fs lb sf ) ctns h 
      ==> Config ct (Container e nil lb sf ) ((Container (return_hole) fs lb sf ) :: ctns) h
