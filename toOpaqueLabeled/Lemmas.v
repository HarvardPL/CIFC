...
-   inversion H_config. inversion H7. subst. inversion H15; subst; auto.
    inversion H1; subst; auto.
    exists (Config CT (Container (toOpaqueLabeled t) fs lb sf) ctns h); auto.
Qed. 
