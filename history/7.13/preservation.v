...
Qed. Hint Resolve  expand_heap_preserve_typed_tm.
  ...
  Proof with eauto.
    ...
    apply expand_heap_preserve_typed_tm; auto.
...
(*Method call normal *)
  ...
  - inversion H_typing; subst; auto.  
    ...
    intros.
    case_eq (beq_id arg_id0 x);intro; 
    unfold sf_update in H16;rewrite H22 in H16.
    inversion H16; subst; auto.
    unfold update_typing in H4;rewrite H22 in H4.
    inversion H4; subst; auto.
...
(*Method call opaque call *)
  - inversion H_typing; subst; auto.  
    ...
    unfold sf_update in H16;rewrite H22 in H16.
    inversion H16; subst; auto.
    unfold update_typing in H1;rewrite H22 in H1.
    inversion H1; subst; auto.
    apply value_typing_invariant_gamma with Gamma';auto.
    inversion H8; subst; auto.
    inversion H25; subst; auto. 
...
- (* Skip*)
  ...
  apply well_typed_sf; auto; intros.
  case_eq (beq_id id x);intro.
  unfold sf_update in H1. rewrite H4 in H1.
  inversion H1; subst; auto.
  apply beq_equal in H4.  subst; auto.
  rewrite H0 in H2; inversion H2; subst; auto.
  unfold sf_update in H1. rewrite H4 in H1.
  inversion H14; subst; auto.
  apply H5 with x; auto. 
