...
Definition bot := LB nil. 

Axiom join_bot_same : forall lb,
    (join_label lb bot) = lb. 
...
Axiom join_def_flow2 : forall (lb1 : Label) (lb2 : Label),
    flow_to lb2 (join_label lb1 lb2) = true.

Axiom flow_trans : forall (lb1 : Label) (lb2 : Label) (lb3 : Label),
    flow_to lb1 lb2 = true ->
    flow_to lb2 lb3 = true ->
    flow_to lb1 lb3 = true.

Axiom flow_dist : forall lb1 lb2,
    flow_to (join_label lb1 lb2) L_Label = true ->
    flow_to lb1 L_Label = true /\ flow_to lb2 L_Label = true. 
    
Axiom join_flow_transitivity : forall lb lb1 lb2,
    flow_to lb1 lb2 = true ->
    flow_to (join_label lb1 lb) (join_label lb2 lb) = true.
