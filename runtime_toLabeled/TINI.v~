...
Proof. intros ct t1 lb1 sf1 h1
       ...
       induction H_reduction2; intros; auto; inversion Heqconfig; inversion Heqconfig'; subst; auto;
         inversion H_low_eq; subst; auto;
                      try (inconsist_label).
       - apply flow_join_label with lb lo; auto.
       - apply flow_join_label with (join_label lo lb) ell; auto.
         apply flow_join_label with lb lo; auto. 
         apply join_label_commutative.
       - apply flow_join_label with lb lo; auto.
       - apply flow_join_label with (join_label lb ell) lo; auto.
         apply flow_join_label with lb ell; auto. 
         apply join_label_commutative.
      ...
      - inversion H17; subst; auto.
       ...
       - inversion H18; subst; auto.
         rewrite H16 in H1. rewrite H17 in H2.
         inversion H1; subst; auto.
         inversion H5; subst; auto.
         destruct ctns2'; unfold low_component in H2.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H8 in H2. inversion H2; subst; auto.
         inversion H24. auto.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H8 in H2; inversion H2; subst; auto.
         inversion H24; auto.  auto. 
                    
         rewrite H16 in H1. rewrite H17 in H2.
         inversion H1; subst; auto.
         destruct ctns2'; unfold low_component in H2.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H7 in H2. inversion H2; subst; auto. auto. 
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H7 in H2; inversion H2; subst; auto. auto.

       - inversion H16; subst; auto.
         rewrite H14 in H. rewrite H15 in H0.
         inversion H; subst; auto.
         inversion H5; subst; auto.
         destruct ctns2'; unfold low_component in H0.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H6 in H0. inversion H0; subst; auto.
         inversion H3; subst; auto.
         inversion H23; subst; auto. auto. 
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H6 in H0. inversion H0; subst; auto. auto. 
                    
         rewrite H14 in H. rewrite H15 in H0.
         inversion H; subst; auto.
         destruct ctns2'; unfold low_component in H0.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H5 in H0. inversion H0; subst; auto. auto. 
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H5 in H0; inversion H0; subst; auto. auto.         
...
Proof. intros ct t2 lb2 sf2 h2
      ...
      - inversion H17; subst; auto.
       ...
       - inversion H18; subst; auto.
         ...
         inversion H5; subst; auto.
         destruct ctns1'; unfold low_component in H1.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H8 in H1. inversion H1; subst; auto.
         inversion H24. auto.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H8 in H1; inversion H1; subst; auto.
         inversion H24; auto.  auto. 
         ...
         destruct ctns1'; unfold low_component in H1.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H7 in H1. inversion H1; subst; auto. auto. 
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H7 in H1; inversion H1; subst; auto. auto.
      ...
      - inversion H16; subst; auto.
         ...
         inversion H3; subst; auto.
         destruct ctns1'; unfold low_component in H.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H6 in H. inversion H; subst; auto.
         inversion H22. auto.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H6 in H; inversion H; subst; auto.
         inversion H22; auto.  auto. 
                    
         rewrite H14 in H. rewrite H15 in H0.
         inversion H0; subst; auto.
         destruct ctns1'; unfold low_component in H.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H5 in H. inversion H; subst; auto. auto. 
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H5 in H; inversion H; subst; auto. auto.  
