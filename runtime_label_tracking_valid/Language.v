...
(* eq comparison *)
  ...
  | ST_EqCmp_result : forall h ct fs v1 v2 ctns sf lb result l' lb',
      value v1 ->
      value v2 ->
...
(* skip *)
  ...
  | ST_val_return_null : forall h ct ctns sf lb lb' sf' fs',
    (*ctn must have return_hole*)
    Config ct (Container null nil lb sf) ((Container return_hole fs' lb' sf') :: ctns) h 
           ==> Config ct (Container null fs' lb' sf') ctns h
