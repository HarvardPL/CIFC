  ...
  - pose proof (excluded_middle_value e).
    ...
    + pose proof (excluded_middle_value argu). destruct H21.
      ++ destruct H28 as [F]. destruct H22 as [lx].
         ...
         case_eq (flow_to lb lx); intro.
         +++ exists (Config ct (Container body nil lx sf' ) ((Container (return_hole) fs lb sf ) :: ctns) h). 
             eauto using reduction.
         +++ exists Error_state; subst; auto.
             eauto using reduction.
      ++ pose proof (exclude_middle_unlabelOpaque argu).
         ...
         +++ destruct H22 as [v]. destruct H22. 
             ...
             ++++ remember ( join_label lb lb0) as lb'. 
                  ...
                  exists (Config ct (Container body nil lo sf' ) ((Container return_hole fs lb sf ) :: ctns) h). 
                  apply ST_MethodCall_unlableOpaque with cls_def F arg_id arguT returnT (join_label lb lb0); auto.
                  subst; auto.
                  +++++ exists Error_state.
