...
(*
    ...
    rewrite H3 in H6; inversion H6; subst; auto.
    ...
    ++ rewrite <- H5 in H; inversion H; subst; auto.
       rewrite <- H7 in H8; inversion H8; subst; auto. 

       exists  φ. split; auto.
       apply L_equivalence_config_H; auto.
       unfold low_component. rewrite H6. rewrite H10. fold low_component.
       apply low_component_irrelevant ; auto. 
...
- inversion H_reduction2; subst; auto; try (solve_by_invert_ctn).
  ...
  + inversion H20; subst; auto.
    ...
    inversion H28; subst; auto. 
    rewrite <- H6 in H; inversion H; subst; auto.
    rewrite <- H8 in H9; inversion H9; subst; auto. 
    ...
    ++ rewrite <- H5 in H; inversion H; subst; auto.
       rewrite <- H7 in H9; inversion H9; subst; auto. 
