...
Proof with eauto.
  ...
  + 
    assert (config' = (Config ct ctn1' ctns1' h1')).
...
Proof. intros ct t1 lb1 sf1 h1
       ...
       - apply flow_transitive with (join_label lb lx); auto.          apply flow_join_label with lb lx; auto.
       ...
       - inversion H17; subst; auto.
         rewrite H15 in H0. rewrite H16 in H1.
         inversion H0; subst; auto.
         inversion H4; subst; auto.
         destruct ctns2'; unfold low_component in H1.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H7 in H1. inversion H1; subst; auto.
         inversion H23. auto.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H7 in H1; inversion H1; subst; auto.
         inversion H23. auto. 
         ...
         destruct ctns2'; unfold low_component in H1.
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H6 in H1. inversion H1; subst; auto. auto. 
         case_eq ( flow_to lb2' L_Label); intro.
         rewrite H6 in H1; inversion H1; subst; auto. auto.
...
Proof. intros ct t2 lb2 sf2 h2
       ...
       - inversion H17; subst; auto.
         ...
         inversion H4; subst; auto.
         destruct ctns1'; unfold low_component in H0.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H7 in H0. inversion H0; subst; auto.
         inversion H23. auto.
         case_eq ( flow_to lb1' L_Label); intro.
         rewrite H7 in H0; inversion H0; subst; auto.
         inversion H23. auto. 
