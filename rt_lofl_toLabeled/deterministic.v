...
(*  Container (toLabeled e1 v) fs lb sf = ctn2 /\ ctns1 = ctns2 /\ h1 = h2 *)
  ...
  - inversion Hy2; subst; auto; try (solve_by_invert_non_value); try (intuition; fail); subst; auto.
    inversion H12.
    apply hole_free_if in H12.
   destruct H12. rewrite H0 in H1. inversion H1; subst; auto.  
  ...
  - inversion Hy2; subst; auto; try (solve_by_invert_non_value); try (intuition; fail); subst; auto.
    destruct H12 with v ell; auto. inversion H1; subst; auto.     
...
Proof with eauto.
  ...
  - inversion Hy2; subst; auto; try (solve_by_invert_non_value); try (intuition; fail); subst; auto.
    rewrite H1 in H13. inversion H13; subst; auto.  
